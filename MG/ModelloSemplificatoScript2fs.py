...
Teff_0 = FuzzySet(points=[[0,1],[0.2,1],[0.8,0],[1,0]], term='Low')
Teff_1 = FuzzySet(points=[[0,0],[0.2,0],[0.8,1],[1,1]], term='High')
FS.add_linguistic_variable('Teff', LinguisticVariable([Teff_0,Teff_1], concept='Teff'))
#Fuzzy rule definition for Treg
Treg_0 = FuzzySet(points=[[0,1],[0.2,1],[0.8,0],[1,0]], term='Low')
Treg_1 = FuzzySet(points=[[0,0],[0.2,0],[0.8,1],[1,1]], term='High')
FS.add_linguistic_variable('Treg', LinguisticVariable([Treg_0,Treg_1], concept='Treg'))
#Fuzzy rule definition for B
B_0 = FuzzySet(points=[[0,1],[0.2,1],[0.8,0],[1,0]], term='Low')
B_1 = FuzzySet(points=[[0,0],[0.2,0],[0.8,1],[1,1]], term='High')
FS.add_linguistic_variable('B', LinguisticVariable([B_0,B_1], concept='B'))
#Fuzzy rule definition for GC
GC_0 = FuzzySet(points=[[0,1],[0.2,1],[0.8,0],[1,0]], term='Low')
GC_1 = FuzzySet(points=[[0,0],[0.2,0],[0.8,1],[1,1]], term='High')
FS.add_linguistic_variable('GC', LinguisticVariable([GC_0,GC_1], concept='GC'))
#Fuzzy rule definition for SLPB
SLPB_0 = FuzzySet(points=[[0,1],[0.2,1],[0.8,0],[1,0]], term='Low')
SLPB_1 = FuzzySet(points=[[0,0],[0.2,0],[0.8,1],[1,1]], term='High')
FS.add_linguistic_variable('SLPB', LinguisticVariable([SLPB_0,SLPB_1], concept='SLPB'))
#Fuzzy rule definition for LLPC
LLPC_0 = FuzzySet(points=[[0,1],[0.2,1],[0.8,0],[1,0]], term='Low')
LLPC_1 = FuzzySet(points=[[0,0],[0.2,0],[0.8,1],[1,1]], term='High')
FS.add_linguistic_variable('LLPC', LinguisticVariable([LLPC_0,LLPC_1], concept='LLPC'))
#Fuzzy rule definition for IgG
IgG_0 = FuzzySet(points=[[0,1],[0.2,1],[0.8,0],[1,0]], term='Low')
IgG_1 = FuzzySet(points=[[0,0],[0.2,0],[0.8,1],[1,1]], term='High')
FS.add_linguistic_variable('IgG', LinguisticVariable([IgG_0,IgG_1], concept='IgG'))
#Fuzzy rule definition for Complement
Complement_0 = FuzzySet(points=[[0,1],[0.2,1],[0.8,0],[1,0]], term='Low')
Complement_1 = FuzzySet(points=[[0,0],[0.2,0],[0.8,1],[1,1]], term='High')
FS.add_linguistic_variable('Complement', LinguisticVariable([Complement_0,Complement_1], concept='Complement'))
#Fuzzy rule definition for Symptoms
Symptoms_0 = FuzzySet(points=[[0,1],[0.2,1],[0.8,0],[1,0]], term='Low')
Symptoms_1 = FuzzySet(points=[[0,0],[0.2,0],[0.8,1],[1,1]], term='High')
FS.add_linguistic_variable('Symptoms', LinguisticVariable([Symptoms_0,Symptoms_1], concept='Symptoms'))
#Fuzzy rule definition for Inflammation
Inflammation_0 = FuzzySet(points=[[0,1],[0.2,1],[0.8,0],[1,0]], term='Low')
Inflammation_1 = FuzzySet(points=[[0,0],[0.2,0],[0.8,1],[1,1]], term='High')
FS.add_linguistic_variable('Inflammation', LinguisticVariable([Inflammation_0,Inflammation_1], concept='Inflammation'))
...
FS.set_variable('Teff', 0.5)
#add fuzzy rules
FS.add_rules(RULES)
#Define initial state for Treg
FS.set_variable('Treg', 0.4)
#add fuzzy rules
FS.add_rules(RULES)
...
FS.set_variable('GC', 0.2)
#add fuzzy rules
FS.add_rules(RULES)
#Define initial state for SLPB
FS.set_variable('SLPB', 0.4)
#add fuzzy rules
FS.add_rules(RULES)
#Define initial state for LLPC
FS.set_variable('LLPC', 0.2)
#add fuzzy rules
FS.add_rules(RULES)
#Define initial state for IgG
FS.set_variable('IgG', 0.2)
#add fuzzy rules
FS.add_rules(RULES)
...
FS.set_variable('Symptoms', 0.2)
#add fuzzy rules
FS.add_rules(RULES)
#Define initial state for Inflammation
FS.set_variable('Inflammation', 0.6)
