...
from MG.MG_Fuzzy_Model import _simulate_data, build_fuzzy_model
...
def run_pomdp_reconstruction():
    ...
    # Parameters
    n_states = 3  # healthy, sick, critical
    n_actions = 1  # wait, treat
    obs_dim = 10  # test_result and symptoms (continuous)
    ...
    observations = _simulate_data(fuzzy_model, 20)
    actions = np.zeros((len(observations), len(observations[0])), dtype=int)  # No actions in this example
